...
user_5 = User.create!(email: 'user5@gmail.com', name: 'mint',   password: 'password', password_confirmation: 'password')
...
m21 = user_5.moments.create!(youtube_vid: 'kE0pwJ5PMDg', start: 50,  stop: nil, name: nil, description: nil)
m22 = user_5.moments.create!(youtube_vid: 'DKNzdBNJ7Bg', start: 75,  stop: nil, name: nil, description: nil)
m23 = user_5.moments.create!(youtube_vid: 'rmLMKZaWlBI', start: 0,   stop: nil, name: nil, description: nil)
m24 = user_5.moments.create!(youtube_vid: 'oGTVoX7AaRc', start: 526, stop: nil, name: nil, description: nil)
m25 = user_5.moments.create!(youtube_vid: 'oGTVoX7AaRc', start: 1000,stop: nil, name: nil, description: nil)
m26 = user_5.moments.create!(youtube_vid: 'fpd_CYrU_Yk', start: 30,  stop: nil, name: nil, description: nil)
m27 = user_5.moments.create!(youtube_vid: 'f6Ye9Qb6Qyk', start: 10,  stop: nil, name: nil, description: nil)
m28 = user_5.moments.create!(youtube_vid: 'wD2E7bjn1sw', start: 52,  stop: nil, name: nil, description: nil)
m29 = user_5.moments.create!(youtube_vid: 'f4fiAChsVpM', start: 4010,stop: nil, name: nil, description: nil)
m30 = user_5.moments.create!(youtube_vid: 'Wc4gEEQbD5w', start: 70,  stop: nil, name: nil, description: nil)
